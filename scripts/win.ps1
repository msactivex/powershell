...
Write-Host Website      : https://msactivex.com
Write-Host ======================================================================================== #>
...
Write-Host "Activating the $edition..." -ForegroundColor Green  
...
Write-Host "(*)Visit https://msactivex.com for more products.`n" -ForegroundColor Cyan
